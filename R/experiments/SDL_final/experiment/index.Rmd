...
tags$script(src='jspsych-6-2/plugins/jspsych-audio-keyboard-response.js'),
tags$script(src='jspsych-6-2/plugins/jspsych-audio-button-response.js'),
...
timeline.push(opening_screen);
timeline.push(fix_audio);
//timeline.push(fullscreen_trial);
//timeline.push(cursor_off);
timeline.push(first_instructions);
timeline.push(xxx_practice_block);
//timeline.push(second_instructions);
//timeline.push(untimed_normal_practice_block);
//timeline.push(third_instructions);
//timeline.push(normal_practice_block);
//timeline.push(normal_practice_block);
//timeline.push(fourth_instructions);
//timeline.push(first_blocks);
//timeline.push(last_blocks);
